...
// 濁音化マッピングテーブル
export const dakuonMap: { [key: string]: string } = {
    'か': 'が',
    'き': 'ぎ',
    'く': 'ぐ',
    'け': 'げ',
...
// 半濁音化マッピングテーブル
export const handakuonMap: { [key: string]: string } = {
    'は': 'ぱ',
    'ひ': 'ぴ',
    'ふ': 'ぷ',
    'へ': 'ぺ',
...
export const youhandakuonMap: { [key: string]: string } = {
  // パ行
  'は': 'ぴゃ',
  'ふ': 'ぴゅ',
  'ほ': 'ぴょ',
...
export const alphabetTable: { [key: string]: number } = {
  ...
  // z:「e」に3と6の点を加える
  z: 0x35,
  // `(グレイヴ)、´(アキュート)、ˆ(サーカム) アクセント符 [4]、0x08（拗音符に同じ）
  // , コンマ [2]、0x02
  ",": 0x02,
  // ; セミコロン [2, 3]、0x06
  ";": 0x06,
  ...
  // - ハイフン [3, 6]、0x24
  "-": 0x24,
  // & アンドマーク [4]、0x08 => [1, 2, 3, 4, 6]、0x2f
  // / スラッシュ  [4, 5, 6]、0x38 => [3, 4]、0x0c
  // –(enダッシュ)、—（emダッシュ） ダッシュ [3, 6]、0x24 => [3, 6]、0x24
  // 点線 [3]、0x04 => [3]、0x04 => [3]、0x04
  // ()丸カッコ [2, 3, 5, 6]、0x36 〜 [2, 3, 5, 6]、0x36
  // []角カッコ [6]、0x20 => [2, 3, 5, 6]、0x36 〜 
  //           [2, 3, 5, 6]、0x36 => [3]、0x04
  // ダブルクォーテンションマーク [2, 3, 6]、0x26 => [3, 5, 6]、0x34
  // --- '…' 直線形（開始記号と終了記号が同じ）
  // --- ‘…’ 曲線形
  "‘": 0x26,
  "’": 0x34,
  // シングルクォーテンションマーク [6]、0x20 => [3, 5, 6]、0x34
  //                           [2, 3, 6]、0x26 => [3]、0x04
  // --- "…" 直線形（開始記号と終了記号が同じ）
  // --- “…” 曲線形
};